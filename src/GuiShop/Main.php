...
public $Blocks = [
  ...
  public $Ores = [
    ...
    "Gold Ingot" => [266,0,300,50],
    "Diamond" => [264,0,500,50],
    "Lapis" => [351,4,500,100]
  ];
  ...
  public $Skulls = [
    "ICON" => ["Skulls",397,0],
    "Zombie Skull" => [397,2,2500,50],
    "Wither Skull" => [397,1,2500,50],
    "Skin Head" => [397,3,1500,10],
    "Creeper Skull" => [397,4,2500,50],
    "Dragon Skull" => [397,5,5000,60],
    "Skeleton Skull" => [397,0,2500,50]
  ];
  ...
  public function sendMainShop(Player $player){
    $ui = new SimpleForm("§bTeronix§bPE §dShop","       §aPurchase and Sell items Here!");
